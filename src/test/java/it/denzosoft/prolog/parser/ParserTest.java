...
public class ParserTest {
    ...
    public void testParseNumber() throws IOException {
        ...
        assertTrue(term instanceof it.denzosoft.prolog.model.Number);
        assertEquals(42.0, ((it.denzosoft.prolog.model.Number)term).getValue(), 0.001);
    }
    ...
    public void testParseStructure() throws IOException {
        ...
        assertEquals("tom", ((Atom)struct.getArgs()[0]).getValue());
        assertEquals("bob", ((Atom)struct.getArgs()[1]).getValue());
    }
    ...
    public void testParseRule() throws IOException {
        ...
        // Check that body is a conjunction structure
        Term body = clause.getBody();
        assertTrue(body instanceof Struct);
        Struct bodyStruct = (Struct) body;
        assertEquals(",", bodyStruct.getFunctor().getValue());
    }
}
