...
public class TermModelTest {
    ...
    public void testVariableBinding() {
        ...
        // After binding, copy should return the bound value
        Map<String, Variable> context = new HashMap<>();
        Term copy = var.copy(context);
    ...
    public void testStructure() throws Exception {
        ...
        Struct copyStruct = (Struct) copy;
        assertEquals(2, copyStruct.getArity());
        // Check that the variable was properly copied
        assertTrue(copyStruct.getArgs()[1] instanceof Variable);
        assertNotSame(args[1], copyStruct.getArgs()[1]);
    }
    ...
    public void testList() {
        ...
        assertFalse(list.isEmpty()); // This list has one element
        ...
        // Test empty list
        List emptyList = new List(empty, empty);
